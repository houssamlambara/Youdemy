...
<body class="bg-gray-50">
    ...
    <div class="relative overflow-hidden bg-blue-600 h-96">
        <img src="/api/placeholder/1920/1080" alt="Education en ligne" class="absolute w-full h-full object-cover opacity-20">
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative h-64">
                    <img src="/api/placeholder/600/400" alt="Mission Youdemy" class="rounded-lg shadow-lg h-full w-full object-cover">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src="/api/placeholder/400/300" alt="Cours d'informatique" class="w-full h-48 object-cover">
                    <div class="p-6">
                ...
                <!-- Design -->
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src="/api/placeholder/400/300" alt="Cours de design" class="w-full h-48 object-cover">
                    <div class="p-6">
                ...
                <!-- Marketing Digital -->
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    <img src="/api/placeholder/400/300" alt="Cours de marketing" class="w-full h-48 object-cover">
                    <div class="p-6">
